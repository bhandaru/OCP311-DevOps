# Lesson Six: Creating a Sample Application via the Web UI
...
_Caution: Do not delete the router deployment configuration. Delete only the running router pod so that a new router container is started._
